...
<head>
	...
	<link rel="icon" href="../manage/lib/img/incons/shop-icon.png" type="image/x-icon"/>
	<link rel="touch-icon" sizes="76x76" href="../manage/lib/img/incons/shop-icon.png" type="image/x-icon"/>
	<style type="text/css">
		* {
...
<body>
	<div id="notfound">
		...
		<div class="notfound">
			...
			<h2>Không Có Phản Hồi</h2>
			<p>Trang không tìm thấy</p>
			<a href="go?page=_home">Trang chủ</a>
		</div>
	</div>
</body>
</html>
